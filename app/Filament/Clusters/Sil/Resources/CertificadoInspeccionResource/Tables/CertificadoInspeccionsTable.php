            ...
            ->recordActions([
                ...
                EditAction::make()
                    ...
                    ->visible(function ($record) {
                        ...
                        if (in_array($user_role_id, [1, 6, 11, 12, 20])) {
                            return true;
                        }
                ...
                Action::make('solicitar_editar')
                    ...
                    ->action(function (array $data, $record) {
                        ...
                        try {
                            ...
                            Notification::make()
                                ->title('Nueva Solicitud de Permiso para Editar ITSE')
                    ...
                    ->visible(function ($record) {
                        ...
                        // Roles 1, 6, 11 y 12 y 20: NO muestran esta acción (ya ven el botón de edición directa)
                        $user_role_id = $user->modelHasRole?->role_id;
                        if (in_array($user_role_id, [1, 6, 11, 12, 20])) {
                            return false;
                        }
                            ...
                            if ($exists && !$tienePermiso) {
                                ...
                                try {
                                    ...
                                    $recipients = \App\Models\User::permission('view::solicitud_permisos')
                                        ->permission('edit::solicitud_permisos')->get();
                                    Notification::make()
                                        ->title('Nueva Solicitud de Permiso para Actualizar Anexo')
                                        ->body("El usuario " . auth()->user()->name . " ha solicitado un permiso.")
                                        ->icon('heroicon-o-document-text')
                                        ->color('warning')
                                        // AQUÍ EL BOTÓN
