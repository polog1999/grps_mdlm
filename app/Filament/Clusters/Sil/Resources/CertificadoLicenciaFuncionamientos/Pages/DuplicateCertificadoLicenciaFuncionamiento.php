...
class DuplicateCertificadoLicenciaFuncionamiento extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        $mapaSimple = [
            ...
            // numero_licencia se deja vacío para que se genere uno nuevo
        ...
        // Limpiar el número de licencia para que se genere uno nuevo
    ...
    {
        // Preparar giros para duplicación
        $giros = [];
        ...
        // Preparar datos para el servicio de duplicación
        // Este servicio usa spu_licencia_upd_duplicar2
        $params = [
