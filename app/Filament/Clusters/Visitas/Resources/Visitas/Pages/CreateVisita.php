    ...
    protected function handleRecordCreation(array $data): Model
    {
        return DB::transaction(function () use ($data) {
            ...
            $visitaData = [
                ...
                'trabajador_id_autoriza' => $data['trabajador_id_autoriza'] ?? null,
                'trabajador_autoriza'    => $data['trabajador_autoriza'] ?? null,
                'trabajador_id_cita'     => $data['trabajador_id_cita'] ?? null,
                'trabajador_cita'        => $data['trabajador_cita'] ?? null,
                'motivo'                 => $data['motivo'],
